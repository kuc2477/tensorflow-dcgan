...
def save_checkpoint(sess, model, iteration, config):
    print()
    print()
    print('#############')
    print('# checkpoint!')
    ...
    checkpoint_name = 'iteration{iteration}.ckpt'.format(iteration=iteration)
...
def load_checkpoint(sess, model, config):
    ...
    return int(checkpoint_name.strip('iteration').rstrip('.ckpt'))
